...
This script performs analysis on Visual Crossing weather data and sales data using the Prophet model.
...
def run_prophet_with_cv(weather_variable_sets, df):
    ...
    final_results.to_csv('output/cross_validation_visual_crossing.csv', index=False)
...
if __name__ == "__main__":
    ...
    weather_file_path = base_dir / 'data' / 'weather_data_vc.csv'
    ...
    df = pd.merge(sales_df, weather_df, left_on='Sales', right_on='datetime')
